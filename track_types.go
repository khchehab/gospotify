...
type TrackObject struct {
	...
	Album CoreAlbumObject `json:"album"`
...
// SimplifiedTrackObject is the simplified object returned by the Spotify API for a track.
...
// SavedTrackObject is the object returned by the Spotify API for a saved track.
